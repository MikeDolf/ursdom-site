...
(function () {
  ...
  (function () {
    ...
    function render() {
      ...
      /* Порог это малый самосвал (TRUCKS[0]), как min_volume
         в статичной таблице. Здесь долго стояло «пяти» от прежнего парка. */
      if (vol < TRUCKS[0]) {
        html += "Объём меньше " + TRUCKS[0] + " кубов: рейс оплачивается целиком, " +
