...
TERMS = [
 (r'щебн[ея]\w*\s+70-150|щеб(?:ень|ня|нем|нём)\s+70-150', '/dostavka/shcheben/frakciya-70-150/'),
 (r'щебн[ея]\w*\s+70-120|щеб(?:ень|ня|нем|нём)\s+70-120', '/dostavka/shcheben/frakciya-70-120/'),
 (r'щебн[ея]\w*\s+10-20|щеб(?:ень|ня|нем|нём)\s+10-20', '/dostavka/shcheben/frakciya-10-20/'),
 (r'щебн[ея]\w*\s+5-10|щеб(?:ень|ня|нем|нём)\s+5-10', '/dostavka/shcheben/frakciya-5-10/'),
