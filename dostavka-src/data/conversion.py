...
"nerud": dict(
 ...
 rows=[
  ("Щебень гранитный 20-40", "от 1400 руб/м³", "/dostavka/shcheben/frakciya-20-40/"),
  ("Щебень гранитный 5-20", "от 1500 руб/м³", "/dostavka/shcheben/frakciya-5-20/"),
  ("Щебень известняковый 20-40", "от 900 руб/м³", "/dostavka/shcheben/"),
...
"plitka": dict(
 ...
 rows=[
  ...
  ("Щебень 20-40 в основание", "от 1400 руб/м³", "/dostavka/shcheben/frakciya-20-40/"),
 ]),
...
"bordyur": dict(
 ...
 rows=[
  ...
  ("Щебень 20-40 под ложе", "от 1400 руб/м³", "/dostavka/shcheben/frakciya-20-40/"),
...
"vodootvod": dict(
 ...
 rows=[
  ...
  ("Щебень 20-40 в обойму", "от 1400 руб/м³", "/dostavka/shcheben/frakciya-20-40/"),
 ]),
...
"kolca": dict(
 ...
 rows=[
  ...
  ("Щебень 20-40 на обсыпку", "от 1400 руб/м³", "/dostavka/shcheben/frakciya-20-40/"),
 ]),
...
"zhbi": dict(
 ...
 rows=[
  ...
  ("Щебень 20-40 в подготовку", "от 1400 руб/м³", "/dostavka/shcheben/frakciya-20-40/"),
 ]),

"asfalt": dict(
 head="Материалы дорожного покрытия с доставкой",
 anchor="Асфальтовая крошка от 450 руб за куб, щебень 20-40 от 1400 с доставкой.",
 rows=[
  ("Асфальтовая крошка", "от 450 руб/м³", "/dostavka/asfaltovaya-kroshka/"),
  ("Щебень гранитный 20-40", "от 1400 руб/м³", "/dostavka/shcheben/frakciya-20-40/"),
...
ORDER_STEPS = [
 "Скажите материал и объём. Не знаете объём: назовите размеры участка работ, посчитаем по формулам из этой статьи.",
