...
NOTE_NERUD = ("Щебень в поиске часто набирают как «щебенка» - это то же самое, "
              "разговорное название той же фракции. Возим от 5 кубов, цена "
              "за куб ниже при большем объёме за одну машину.")
